...
iven two strings s and t, return the number of distinct subsequences of s which equals t.
 ...
 */
 var numDistinct = function(s, t) {
    ...
    const dp = new Array(t.length + 1).fill(0).map(_ => new Array(s.length + 1).fill(0));
