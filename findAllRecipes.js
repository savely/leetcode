 ...
 */
 var findAllRecipes = function(recipes, ingredients, supplies) {
    ...
    const suppliesSet = new Set(supplies), ans = [];
    ...
    while(true) {
        ...
        for(const recipe in recipesMap) {

            const i = recipesMap[recipe];

            let hasAllIngridients = true;

            for(const ingridient of ingredients[i]) {

                if(!suppliesSet.has(ingridient)) {
            ...
            if(hasAllIngridients) {
                ...
                delete recipesMap[recipe];
            }

            hasNewRecipe |= hasAllIngridients;
        }

        if(!hasNewRecipe) break;
    }
