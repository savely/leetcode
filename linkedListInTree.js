...
var isSubPath = function(head, root) {
    ...
    const dfs = (node) => {
        ...
        return check(head, node) || dfs(node.left) || dfs(node.right);
    }
...
let root = [1,null,1,10,1,9], head = [1,10];
//head = [1,4,2,6,8], root = [1,4,4,null,2,2,null,1,null,6,8,null,null,null,null,1,3];

console.log(isSubPath(arrayToList(head), fromArray(root)));